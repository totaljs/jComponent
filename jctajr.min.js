...
return FIND(t,!0).forEach(function(t){"function"==typeof t[e]?t[e].apply(t,r):t[e]=r[0]}),n.SETTER},window.EXEC=function(t){for(var e=window,n=[],r=1;r<arguments.length;r++)n.push(arguments[r]);var i=GET(t);return"function"==typeof i&&i.apply(e,n),e.EXEC},window.NOOP=function(){};